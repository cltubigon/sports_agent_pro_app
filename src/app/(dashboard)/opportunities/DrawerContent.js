...
const DrawerContent = ({ account_type, drawer, setdrawer }) => {
    ...
    <div className={'flex flex-col justify-between w-full h-full'}>
        ...
        >
          ...
          <Container>
            ...
            <div className={'flex flex-col'}>
              ...
              <p className={' line-clamp-1'}>
                Total <span className="font-semibold">${drawer?.total}</span>
              </p>
            </div>
          </Container>
          {/* Brief */}
      ...
      {(account_type === 'athlete' || account_type === 'coach') && (
        ...
        >
          <ApplyButton
            item={drawer}
            applications={drawer?.applications ? drawer?.applications : null}
          />
        </div>
      )}
    </div>
